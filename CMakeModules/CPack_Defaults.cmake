...
# Set default data rootdir
IF(NOT DEFINED CMAKE_INSTALL_DATAROOTDIR)
SET(CMAKE_INSTALL_DATAROOTDIR "share" CACHE PATH "data destination root directory")
...
IF(WIN32)
  SET(CPACK_PACKAGE_INSTALL_DIRECTORY "Adalin\\\\${PACKAGE_NAME}")
  ...
  SET(CPACK_NSIS_MENU_LINKS "http://www.adalin.com" "Homepage for ${PACKAGE_NAME}")
  
  # Icon in the add/remove control panel. Must be an .exe file 
  SET(CPACK_NSIS_INSTALLED_ICON_NAME bin\\\\${PACKAGE}.exe)
  
  # SET(CPACK_CREATE_DESKTOP_LINKS "${PACKAGE_NAME}")
  SET(CPACK_NSIS_EXTRA_INSTALL_COMMANDS "
    CreateShortCut \\\"$DESKTOP\\\\${PACKAGE_NAME}.lnk\\\" \\\"$INSTDIR\\\\bin\\\\${PACKAGE}.exe\\\"
  ")
